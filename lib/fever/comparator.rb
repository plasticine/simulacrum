...
module Fever
  ...
  class Comparator
    def self.test(component)
      ...
      if component.reference?
        ...
        if diff.nil?
          ...
          diff.save()
          candidate.save()
          raise "Images are not the same! Please resolve the diff!"
        end
    ...
    def self.diff(component, candidate)
    ...
    def self.compare_images(reference_image, candidate_image)
